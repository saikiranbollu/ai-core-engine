...
**Effective Date**: 2026-05-01 (v2.0.0)
...
## 5. Review Requirements by ASIL Level (REVISED — v2.0.0)
...
**Technical enforcement (v2.0.0):** The review gate `evaluate_confidence` tool **hard-gates** ASIL-D artifacts to FULL + independent + safety manager — the confidence score cannot bypass this. See AICE_SYSTEM_CARD §6.2.
...
|---|---|---|---|
| **Public** | Published AUTOSAR standard text, public TC3xx datasheet | ✅ Allowed | Optional |
| **Internal non-sensitive** | Generic MISRA reasoning, embedded C patterns | ✅ Allowed | Optional |
| **Infineon confidential** | Unpublished errata, TC4xx pre-release, internal design notes, proprietary ontology | ❌ Not permitted | **Required** |
...
| Standard / Regulation | Relevance | Applicability to AICE |
|---|---|---|
| **EU AI Act (2024/1689)** | Art. 4 (literacy), Art. 11 (documentation), Art. 12 (records), Art. 13 (transparency), Art. 14 (oversight), Art. 50 (disclosure), Art. 53 (GPAI), Art. 73 (incidents) | Applicable |
| **NIST AI RMF 1.0 + GenAI Profile + SP 800-218A** | Trustworthy AI; GenAI-specific controls; secure dev for GenAI | Adopted as reference |
| **ISO/IEC 42001:2023** | AIMS | AIMS documentation in progress |
| **ISO 26262 Part 8 Clause 11** | Tool qualification | See AICE-GOV-007 |
| **ISO 26262 Part 6** | Software development + independence of review | Applicable to output, reinforced for AI-authored |
| **ISO/SAE 21434** | Cybersecurity | AI-extended TARA planned (AICE-GOV-008) |
| **ISO/PAS 8800:2024** | Road vehicles — Safety and AI | **Not applicable to AICE** per std's own scope exclusion |
| **ISO/IEC TS 22440** | AI functional safety | CD stage, watch-list |
| **ASPICE 4.0** | Process maturity; SWE.1–6 + SUP.11 | Applicable; MLE **not triggered** (no fine-tuning) |
| **VDA AI-in-QM Yellow Volume (Mar 2026) — Chapter 7** | Risk-based assessment of AI development tools | Adopted as internal method |
| **MISRA C:2012** | Coding standard | Mandatory for all AI-generated C |
| **AUTOSAR CP/Adaptive** | Architecture | Mandatory |
| **GDPR / DPDP** | Personal data | PII scrubber required |
| **UNECE R155/R156** | Cybersecurity / SW updates | Applicable via ISO/SAE 21434 |
