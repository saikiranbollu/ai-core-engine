...
| **2.1.0** | **2026-04-20** | **ATV MC D SW VDF** | **Phase 0 extended with sandbox recovery step. 5 new sandbox-related root cause categories (content error, content loss, prompt injection leak, data-class leak, semantic cache bleed) with corrective actions. Sandbox Content Loss classified as CRITICAL Art. 12 compliance failure. Cross-refers to AICE-GOV-010** |
