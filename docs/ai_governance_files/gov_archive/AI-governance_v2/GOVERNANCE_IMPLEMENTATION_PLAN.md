...
| System Card v2.0.0 | — | Delivered | Done |
| AI Usage Policy v2.0.0 | — | Delivered | Done |
| Data Governance Policy v1.1.0 | — | Delivered | Done |
| Incident Response v2.0.0 | — | Delivered | Done |
...
- PII scrubber active on prompt path with test canaries
- ASIL-D artifacts hard-gated to FULL+independent+safety-mgr
- All v2.0.0 policy docs in repo
